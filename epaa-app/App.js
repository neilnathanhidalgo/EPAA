  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Splash">
        ...
        <Stack.Screen name="CuiLogin" component={CuiLogin} options={{ headerShown: false }} />
        <Stack.Screen name="UALogin" component={UALogin} options={{ headerShown: false }} />
        <Stack.Screen name="HomeUA" component={HomeUA} options={{ headerShown: false }} />
        <Stack.Screen name="HomeCui" component={HomeCui} options={{ headerShown: false }} />

        <Stack.Screen name="AlertaCaidaUA" component={AlertaCaidaUA} options={{ headerShown: false }} />
